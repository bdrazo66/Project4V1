# word process NLP project4
this app edit and coded bu Badr 
and this fourth project that we deal with webpack and loader and plugins and entrypoint and outputs also we deal with many tools and two mode producation and development and we deal with sass files and to translate to css files and how to deal with api and many information that i faced for the first time and i faced many challangies that makes me and give me better understanding how to solve error and how to search for soulations to try solve conflicts .

## subject 
NLP (word processing semnitet) App Project
